...
var mongoose     = require('mongoose'),
    mongooseIntlPlugin = require('mongoose-intl-plugin'),
...
_Note:_ `intl` option its only available for `String` type fields.

```js
Post.plugin(mongooseIntlPlugin, {
  languages: ["en", "pt", "de"],
  defaultLanguage: "pt",
});
```
...
```js
mongoose.plugin(mongooseIntlPlugin, {
  languages: ["en", "pt", "de"],
  defaultLanguage: "pt",
});
```

# Overview ([alexsk/mongoose-intl](https://github.com/alexsk/mongoose-intl))
